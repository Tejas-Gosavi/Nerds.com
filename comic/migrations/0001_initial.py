# Generated by Django 3.2.7 on 2021-11-17 19:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "main_image",
                    models.ImageField(
                        upload_to=comic.models.comic_images_directory_path
                    ),
                ),
                (
                    "other_image1",
                    models.ImageField(
                        blank=True, upload_to=comic.models.comic_images_directory_path
                    ),
                ),
                (
                    "other_image2",
                ...
                ("art_by", models.CharField(blank=True, max_length=50)),
                ("page_count", models.IntegerField(blank=True)),
                (
                    "age_rating",
                    models.CharField(
                        blank=True,
                        choices=[("13+", "13+"), ("15+", "15+"), ("18+", "18+")],
                        max_length=5,
                    ),
                ),
                ...
                (
                    "brand",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="comic.brand"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "verbose_name_plural": "Individual Issues",
            },
            bases=("comic.comic",),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume_title",
                    models.CharField(max_length=255, verbose_name="Volume Name"),
                ),
                (
                    "volume_slug",
                    models.SlugField(unique=True, verbose_name="Volume Slug"),
                ),
                (
                    "volume_main_image",
                    models.ImageField(
                        upload_to=comic.models.volume_images_directory_path
                    ),
                ),
                (
                    "volume_start",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="comic.comictype"
            ),
        ),
        migrations.AddField(
            model_name="comic",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="comic.volume"
                    ),
                ),
            ],
            options={
                "verbose_name": "Single",
                "verbose_name_plural": "Single Issues",
            },
            bases=("comic.comic",),
        ),
    ]
