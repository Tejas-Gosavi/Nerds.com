...
$("#state").change(function () {
    ...
    htmlString = htmlString + "<option value='' selected>Select District</option>"
...
$("#addressBtn").click(function () { 
    var state = $("#userState").text();
    var district = $("#userDistrict").text();

    if (state !== "" && district !== "")
    {
        let optionsList = Function("return " + state)();
        let htmlString = ""
        htmlString = htmlString + "<option value='' selected>Select District</option>"
        for (var i = 0; i < optionsList.length; i++) {
            htmlString = htmlString + "<option value='" + optionsList[i] + "'>" + optionsList[i] + "</option>";
